...
const projects = [
  ...
  },
  {
    ...
    description:
      "Carolina Grazing Co. crafts elevated, artfully designed grazing experiences using locally sourced, seasonal ingredients. Serving Charlotte and Lake Norman, we bring beautifully curated tables that make every event unforgettable.",
    image: "/image.png",
    link: "https://www.carolinagrazingco.com/",
  },
  {
...
const Projects = () => {
  return (
    <div className="bg-gray-900">
      <section
        id="projects"
        className="relative bg-gray-950 text-white py-20 px-6"
      >
        ...
        <div className="flex justify-center mt-10">
          <Link
            to="/projects"
            className="flex justify-center items-center w-40 h-14 bg-gradient-to-r from-sky-500 to-pink-500 text-white font-semibold rounded-lg shadow-md hover:shadow-lg hover:scale-105 transition-transform duration-300"
          >
            View All Projects
          </Link>
        </div>
